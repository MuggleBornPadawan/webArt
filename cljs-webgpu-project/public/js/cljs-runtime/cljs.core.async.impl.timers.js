...
var i_14439 = (0);
while(true){
if((i_14439 < arr.length)){
(arr[i_14439] = null);

var G__14448 = (i_14439 + (1));
i_14439 = G__14448;
continue;
} else {
}
...
var i_14510 = (self__.level + (1));
while(true){
if((i_14510 <= (new_level + (1)))){
(update[i_14510] = self__.header);

var G__14515 = (i_14510 + (1));
i_14510 = G__14515;
continue;
} else {
}
...
while(true){
if((i <= self__.level)){
var links_14517 = (update[i]).forward;
if((i < x__$2.forward.length)){
(x__$2.forward[i] = (links_14517[i]));
} else {
x__$2.forward.push((((i < links_14517.length))?(links_14517[i]):null));
}

if((i < links_14517.length)){
(links_14517[i] = x__$2);
} else {
links_14517.push(x__$2);
}
...
var i_14522 = (0);
while(true){
if((i_14522 <= self__.level)){
var links_14524 = (update[i_14522]).forward;
if((x__$1 === (((i_14522 < links_14524.length))?(links_14524[i_14522]):null))){
(links_14524[i_14522] = (x__$1.forward[i_14522]));

var G__14525 = (i_14522 + (1));
i_14522 = G__14525;
continue;
} else {
var G__14526 = (i_14522 + (1));
i_14522 = G__14526;
continue;
}
} else {
...
var G__14531 = nx;
var G__14532 = (level__$1 - (1));
x = G__14531;
level__$1 = G__14532;
continue;
} else {
var G__14533 = x;
var G__14534 = (level__$1 - (1));
x = G__14533;
level__$1 = G__14534;
continue;
}
...
if(cljs.core.truth_(nx)){
var G__14537 = nx;
var G__14539 = (level__$1 - (1));
x = G__14537;
level__$1 = G__14539;
continue;
} else {
var G__14540 = x;
var G__14541 = (level__$1 - (1));
x = G__14540;
level__$1 = G__14541;
continue;
}
