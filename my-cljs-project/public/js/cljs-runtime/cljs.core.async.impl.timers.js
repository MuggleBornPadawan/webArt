...
var i_12692 = (self__.level + (1));
while(true){
if((i_12692 <= (new_level + (1)))){
(update[i_12692] = self__.header);

var G__12693 = (i_12692 + (1));
i_12692 = G__12693;
continue;
} else {
}
...
while(true){
if((i <= self__.level)){
var links_12697 = (update[i]).forward;
if((i < x__$2.forward.length)){
(x__$2.forward[i] = (links_12697[i]));
} else {
x__$2.forward.push((((i < links_12697.length))?(links_12697[i]):null));
}

if((i < links_12697.length)){
(links_12697[i] = x__$2);
} else {
links_12697.push(x__$2);
}
...
var i_12700 = (0);
while(true){
if((i_12700 <= self__.level)){
var links_12703 = (update[i_12700]).forward;
if((x__$1 === (((i_12700 < links_12703.length))?(links_12703[i_12700]):null))){
(links_12703[i_12700] = (x__$1.forward[i_12700]));

var G__12706 = (i_12700 + (1));
i_12700 = G__12706;
continue;
} else {
var G__12707 = (i_12700 + (1));
i_12700 = G__12707;
continue;
}
} else {
...
var G__12713 = nx;
var G__12714 = (level__$1 - (1));
x = G__12713;
level__$1 = G__12714;
continue;
} else {
var G__12715 = x;
var G__12716 = (level__$1 - (1));
x = G__12715;
level__$1 = G__12716;
continue;
}
