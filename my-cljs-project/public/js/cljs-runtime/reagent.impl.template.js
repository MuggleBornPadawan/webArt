...
var G__8862 = o;
reagent.impl.template.goog$module$goog$object.set(G__8862,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
while (G__9002__i < G__9002__a.length) {G__9002__a[G__9002__i] = arguments[G__9002__i + 0]; ++G__9002__i;}
  args = new cljs.core.IndexedSeq(G__9002__a,0,null);
} 
...
var G__8873 = o;
reagent.impl.template.goog$module$goog$object.set(G__8873,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
if(cljs.core.ifn_QMARK_(x)){
return (function() { 
var G__9007__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
var G__9007 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__9008__i = 0, G__9008__a = new Array(arguments.length -  0);
while (G__9008__i < G__9008__a.length) {G__9008__a[G__9008__i] = arguments[G__9008__i + 0]; ++G__9008__i;}
  args = new cljs.core.IndexedSeq(G__9008__a,0,null);
} 
return G__9007__delegate.call(this,args);};
G__9007.cljs$lang$maxFixedArity = 0;
G__9007.cljs$lang$applyTo = (function (arglist__9009){
var args = cljs.core.seq(arglist__9009);
return G__9007__delegate(args);
});
...
var G__8877 = props;
var G__8877__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__8877,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__8877);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__8877__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__5025__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__8880 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__8880,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__8880;
}
})(),id_class);
...
var temp__5823__auto___9011 = (function (){var and__5023__auto__ = js_props;
...
if(cljs.core.truth_(temp__5823__auto___9011)){
var d_9012 = temp__5823__auto___9011;
if((d_9012 instanceof reagent.impl.template.UnsafeHTML)){
(js_props.dangerouslySetInnerHTML = ({"__html": d_9012.s}));
} else {
...
var G__8881 = (cljs.core.count(argv) - first_child);
switch (G__8881) {
case (0):
...
var vec__8882 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__8882,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__8882,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__8882,(2),null);
...
var temp__5827__auto___9018 = reagent.impl.util.react_key_from_vec(v);
if((temp__5827__auto___9018 == null)){
} else {
var key_9019 = temp__5827__auto___9018;
...
var temp__5827__auto___9021 = reagent.impl.util.react_key_from_vec(v);
if((temp__5827__auto___9021 == null)){
} else {
var key_9022 = temp__5827__auto___9021;
(jsprops.key = key_9022);
}
...
var temp__5827__auto___9025 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5827__auto___9025 == null)){
} else {
var key_9026 = temp__5827__auto___9025;
(jsprops.key = key_9026);
}
...
var temp__5827__auto___9033 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5827__auto___9033 == null)){
} else {
var key_9034 = temp__5827__auto___9033;
...
var temp__5827__auto___9035 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5827__auto___9035 == null)){
} else {
var key_9036 = temp__5827__auto___9035;
(jsprops.key = key_9036);
}
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__8915_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__8915_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__8930 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__8930,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__8930,(1),null);
...
break;
default:
var G__9046 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
var G__9047 = compiler;
v = G__9046;
compiler = G__9047;
continue;
...
*/
reagent.impl.template.t_reagent$impl$template8980 = (function (opts,id,fn_to_element,parse_fn,meta8981){
this.opts = opts;
this.id = id;
...
(reagent.impl.template.t_reagent$impl$template8980.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_8982,meta8981__$1){
var self__ = this;
var _8982__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template8980(self__.opts,self__.id,self__.fn_to_element,self__.parse_fn,meta8981__$1));
}));

(reagent.impl.template.t_reagent$impl$template8980.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_8982){
var self__ = this;
var _8982__$1 = this;
return self__.meta8981;
}));

(reagent.impl.template.t_reagent$impl$template8980.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template8980.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template8980.prototype.reagent$impl$protocols$Compiler$parse_tag$arity$3 = (function (this$,tag_name,tag_value){
var self__ = this;
var this$__$1 = this;
...
(reagent.impl.template.t_reagent$impl$template8980.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template8980.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template8980.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"parse-fn","parse-fn",-836029424,null),new cljs.core.Symbol(null,"meta8981","meta8981",1661893862,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template8980.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template8980.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template8980");

(reagent.impl.template.t_reagent$impl$template8980.cljs$lang$ctorPrWriter = (function (this__5310__auto__,writer__5311__auto__,opt__5312__auto__){
return cljs.core._write(writer__5311__auto__,"reagent.impl.template/t_reagent$impl$template8980");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template8980.
 */
reagent.impl.template.__GT_t_reagent$impl$template8980 = (function reagent$impl$template$__GT_t_reagent$impl$template8980(opts,id,fn_to_element,parse_fn,meta8981){
return (new reagent.impl.template.t_reagent$impl$template8980(opts,id,fn_to_element,parse_fn,meta8981));
});
...
return (new reagent.impl.template.t_reagent$impl$template8980(opts,id,fn_to_element,parse_fn,cljs.core.PersistentArrayMap.EMPTY));
});
