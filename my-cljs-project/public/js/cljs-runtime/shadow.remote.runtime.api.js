...
var shadow$remote$runtime$api$IRuntime$relay_msg$dyn_12319 = (function (runtime,msg){
...
return shadow$remote$runtime$api$IRuntime$relay_msg$dyn_12319(runtime,msg);
}
});

var shadow$remote$runtime$api$IRuntime$add_extension$dyn_12324 = (function (runtime,key,spec){
var x__5373__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$add_extension$dyn_12324(runtime,key,spec);
}
});

var shadow$remote$runtime$api$IRuntime$del_extension$dyn_12325 = (function (runtime,key){
var x__5373__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$del_extension$dyn_12325(runtime,key);
}
});
...
var shadow$remote$runtime$api$Inspectable$describe$dyn_12326 = (function (thing,opts){
...
return shadow$remote$runtime$api$Inspectable$describe$dyn_12326(thing,opts);
}
}
});
...
var shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_12333 = (function (runtime,input,callback){
var x__5373__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_12333(runtime,input,callback);
}
});
...
var shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_12338 = (function (runtime,code,success,fail){
var x__5373__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_12338(runtime,code,success,fail);
}
});


shadow.remote.runtime.api.cljs_eval = (function shadow$remote$runtime$api$cljs_eval(runtime,p__12314,callback){
var map__12315 = p__12314;
var map__12315__$1 = cljs.core.__destructure_map(map__12315);
var input = map__12315__$1;
var code = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12315__$1,new cljs.core.Keyword(null,"code","code",1586293142));
var ns = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12315__$1,new cljs.core.Keyword(null,"ns","ns",441598760));
